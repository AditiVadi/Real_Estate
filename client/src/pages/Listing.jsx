        ...
        <div>
          ...
          <div className='flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4'>
            <p className='text-2xl font-semibold flex items-center'>
              {listing.name} - <FaRupeeSign className='text-2xl  mx-0 font-semibold  flex flex-wrap items-center gap-4 sm:gap-6' />{' '}
              {listing.offer
            ...
            <div className='flex gap-4'>
              ...
              {listing.offer && (
                <p className='bg-green-900 w-full max-w-[200px] text-white text-center p-1 rounded-md flex justify-center items-center'>
                  <FaRupeeSign className='text-white font-semibold text-sm mr-2' />
