    ...
    return (
        <main className='p-3 max-w-4xl mx-auto'>
            ...
            <form className='flex flex-col sm:flex-row gap-4'>
                <div className='flex flex-col gap-4 flex-1'>
                    ...
                    <div className='flex gap-6 flex-wrap'>
                        <div className='flex gap-2'>
                            <input type="checkbox" ig='sale' className='w-5 ' />
                            <span>Sell</span>
                        </div>
                        <div className='flex gap-2'>
                            <input type="checkbox" ig='rent' className='w-5 ' />
                            <span>Rent</span>
                        </div>
                        <div className='flex gap-2'>
                            <input type="checkbox" ig='parking' className='w-5 ' />
                            <span>Parking Spot</span>
                        </div>
                        <div className='flex gap-2'>
                            <input type="checkbox" ig='furnished' className='w-5 ' />
                            <span>Furnished</span>
                        </div>
                        <div className='flex gap-2'>
                            <input type="checkbox" ig='offer' className='w-5 ' />
                            <span>Offer</span>
                        </div>
                    </div>
                ...
                <span className='font-normal text-gray-600 ml-2'>The frist image will be the cover(max 6)</span>
                </p>
